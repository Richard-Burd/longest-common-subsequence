// In this algorithm, the "totalChildrenCount" includes adding up the "childCount"
// before going on to loop over each "totalChildrenCount" and adding them to the
// location.  This only effects the output with smaller strings in the input data set
// whereas the number of "childCount" for each location gets dwarfed by the
// "totalChildrenCount" numbers being added up from below (in the descendent tree)
